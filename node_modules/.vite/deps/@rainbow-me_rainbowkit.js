...
import {
  require_dijkstra
} from "./chunk-APQMG4MK.js";
import {
  en_US_default
} from "./chunk-EZ7QRVJB.js";
import {
  __assign,
  __rest,
  __spreadArray,
  init_tslib_es6
} from "./chunk-FDEC4PTA.js";
import {
  require_react_dom
} from "./chunk-LKJDESOZ.js";
import {
  mainnet
} from "./chunk-SPNB5UJA.js";
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-SF3AQNJF.js";
import "./chunk-KO32JKQ2.js";
import {
  useQuery
} from "./chunk-MLMII4YE.js";
...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-5VF3KJPM.js";
import "./chunk-P3XWFZ4H.js";
import "./chunk-SP5EVH4A.js";
import "./chunk-HAHJH3IH.js";
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-VQOMRY33.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-CPVZXXSR.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-S3KHYNIC.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-MZOGNWDG.js");
...
function Avatar({ address, imageUrl, loading, size }) {
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      ...
      import_react9.default.createElement(AvatarComponent, { address, ensImage: imageUrl, size })
    ),
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-EFG7DWCD-FHGIWT2W.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-YBXRRIY6-IOHAHNCD.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-HHD3PTWJ-FU3JNMUI.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-YJOM2FKT-XQ63UTQI.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-6LCB42ZP-5TBYJJFE.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-XEJUOSPY-CSWHMAIZ.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-Y2UY5DJF-S2LQ4QK3.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-XEZDL32S-Y7UCGZ4C.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-URWA5SSF-LQ23EZ6J.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-S2JHPZU4-MINPUZJW.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-ERMCTL3T-BXURMJNO.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-7U4SQPKU-GKWB4HML.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-EWJFZZZQ-5UN2Q7UG.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-R6N3SRTH-3HIJ5LB5.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-ZZAF3UAE-CEUVQPKH.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-KSS4HRUK-6XSKQMHN.js")).default;
    default:
      return (await import("./en_US-YBXRRIY6-IOHAHNCD.js")).default;
  }
};
...
var celoIcon = {
  ...
  iconUrl: async () => (await import("./celo-E6XU57FO-IORCWL5P.js")).default
};
var cronosIcon = {
...
var gnosisIcon = {
  ...
  iconUrl: async () => (await import("./gnosis-T7U5EW2Q-6G2XWHS7.js")).default
};
var hardhatIcon = {
...
var klaytnIcon = {
  ...
  iconUrl: async () => (await import("./klaytn-QTDBZIB3-33HQ4CG4.js")).default
};
var optimismIcon = {
...
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-KBL3OIYT-MPIXQP3A.js")).default
};
var polygonIcon = {
...
var DisconnectSqIcon = ({ size }) => import_react54.default.createElement(
  "svg",
  {
    fill: "none",
    height: size,
...
function QRCode({
  ...
  return import_react73.default.createElement(
    ...
    import_react73.default.createElement(
      ...
      import_react73.default.createElement("svg", { height: size, style: { all: "revert" }, width: size }, import_react73.default.createElement("title", null, "QR Code"), import_react73.default.createElement("defs", null, import_react73.default.createElement("clipPath", { id: "clip-wrapper" }, import_react73.default.createElement("rect", { height: logoWrapperSize, width: logoWrapperSize })), import_react73.default.createElement("clipPath", { id: "clip-logo" }, import_react73.default.createElement("rect", { height: logoSize, width: logoSize }))), import_react73.default.createElement("rect", { fill: "transparent", height: size, width: size }), dots)
    )
  );
}
  ...
  return import_react59.default.createElement(
    ...
    (compactModeEnabled ? walletStep === "NONE" : true) && import_react59.default.createElement(
      ...
      import_react59.default.createElement(Box, { className: ScrollClassName, paddingBottom: "18" }, Object.entries(groupedWallets).map(
        ([groupName, wallets2], index) => wallets2.length > 0 && import_react59.default.createElement(import_react59.Fragment, { key: index }, groupName ? import_react59.default.createElement(Box, { marginBottom: "8", marginTop: "16", marginX: "6" }, import_react59.default.createElement(
          Text,
          {
      ...
      walletContent = import_react74.default.createElement(Box, null, import_react74.default.createElement(
        ...
        mobileWallets.map((wallet, index) => {
          ...
          return import_react74.default.createElement(
            ...
            )), index < mobileWallets.length - 1 && import_react74.default.createElement(
              Box,
              {
                background: "generalBorderDim",
                height: "1",
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-VUYZPLY4-K3AK4XOU.js")).default,
  installed: (
